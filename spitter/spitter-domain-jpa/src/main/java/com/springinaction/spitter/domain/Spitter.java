...
public class Spitter implements Serializable {
  ...
  @Size(min=3, max=20, message=
      "Nazwa u¿ytkownika musi siê sk³adaæ z 3 do 20 znaków.") //<co id="co_enforceSize"/> 
  @Pattern(regexp="^[a-zA-Z0-9]+$",
          message="Nazwa u¿ytkownika musi siê sk³adaæ ze znaków alfanumerycznych bez spacji.")  //<co id="co_noSpaces"/>
  private String username;  
  
  @Size(min=6, max=20,
          message="Has³o nie mo¿e byæ krótsze ni¿ 6 znaków.") //<co id="co_enforceSize"/>
  private String password;

  @Size(min=3, max=50, message=
      "Imiê i nazwisko musi siê sk³adaæ z co najmniej 3 i nie wiêcej ni¿ 50 znaków.")    //<co id="co_enforceSize"/>   
